...
class GuardianshipAgent(LegalSpecialistAgent):
    ...
    def _define_schema_fields(self) -> Dict[str, LegalSchemaField]:
        ...
        return {
            # TODO: Define guardianship-specific fields
            # Examples: guardianship_type, ward_age, incapacitation_type, etc.
        }
    ...
    def process(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            # TODO: Implement guardianship-specific processing logic
            ...
            return {
                "question": "Guardianship specialist is under development. Please check back soon.",
    ...
    def _format_question(self, field_name: str, case_info: Dict[str, Any]) -> str:
        ...
        # TODO: Implement guardianship-specific questions
